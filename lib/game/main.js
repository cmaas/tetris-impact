...
MyGame = ig.Game.extend({
	...
	init: function() {
        ...
        this.gameState = MyGame.state.STAGE_SELECT;        
    ...
    startRound: function() {
        ...
        this.roundManager.startRound( this.stageSelector.getSelectedStage() );
    ...
    gameOver: function( roundScore ) {
        if (typeof ig.setScoreCallback === 'function') {
            ig.setScoreCallback( roundScore, this.finalizeScore( roundScore ) );
        }
    },
